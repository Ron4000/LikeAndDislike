...
function ContentRating() {
  const [likes, setLikes] = reactExports.useState(0);
  const [dislikes, setDislikes] = reactExports.useState(0);
  const handleLike = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "content-rating", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Mas Bagay padin talaga ang papaya sa tinola kesa sa sayote!" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rating-buttons", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: handleLike, children: [
        "Like ",
        likes
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: handleDislike, children: [
        "Dislike ",
        dislikes
      ] })
    ] })
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "app-shell", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContentRating, {}) });
}
